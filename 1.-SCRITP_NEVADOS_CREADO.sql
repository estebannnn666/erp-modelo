...
INSERT INTO SCVNTSECUENCIAS(NOMBRESECUENCIA,VALORSECUENCIA) VALUES('SCVNSECUSUARIO', 1);
INSERT INTO SCVNTSECUENCIAS(NOMBRESECUENCIA,VALORSECUENCIA) VALUES('SCVNSECMODULOS', 12);
INSERT INTO SCVNTSECUENCIAS(NOMBRESECUENCIA,VALORSECUENCIA) VALUES('SCVNSECPERFIL', 3);
...
UPDATE SCVNTCATALOGOVALOR SET NOMBRECATALOGOVALOR = 'VENTA' WHERE CODIGOCATALOGOVALOR = 'VEN' AND CODIGOCATALOGOTIPO = 8;
UPDATE SCVNTCATALOGOVALOR SET NOMBRECATALOGOVALOR = 'COMPRA' WHERE CODIGOCATALOGOVALOR = 'COM' AND CODIGOCATALOGOTIPO = 8;
...
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (1, 'M-1', 1, 'ARTÍCULOS', 'MODULO DE ARTICULOS', 'styleArticle', 'GES', '/modules/articulos/adminBusquedaArticulos.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (2, 'M-2', 2, 'CLIENTES', 'MODULO DE CLIENTES', 'styleClient', 'GES', '/modules/clientes/adminBusquedaClientes.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (3, 'M-3', 3, 'PEDIDOS', 'MODULO DE PEDIDOS', 'stylePedidos', 'GES', '/modules/pedidos/adminBusquedaPedidos.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (4, 'M-4', 4, 'TRANSPORTISTAS', 'MODULO DE TRANSPORTISTAS', 'GES', 'styleTransportista', '/modules/transportistas/adminBusquedaTransportista.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (5, 'M-5', 5, 'CHOFER', 'MODULO DE CHOFER', 'styleChofer', 'GES', '/modules/chofer/adminBusquedaChofer.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (6, 'M-6', 6, 'VEHÍCULOS', 'MODULO DE VEHÍCULOS', 'styleVehiculo', 'GES', '/modules/vehiculo/adminBusquedaVehiculo.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (7, 'M-7', 7, 'DESPACHOS', 'MODULO DE DESPACHOS', 'styleDespacho', 'GES', '/modules/despachos/adminBusquedaDespacho.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (8, 'M-8', 8, 'FACTURAS', 'MODULO DE FACTURAS', 'styleFactura', 'GES', '/modules/facturas/adminBusquedaCuentas.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (9, 'M-9', 9, 'USUARIOS', 'MODULO DE USUARIOS', 'styleUsuario', 'ADM', '/modules/usuarios/adminBusquedaUsuarios.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (10, 'M-10', 10, 'MODULOS', 'MODULO DE MODULOS', 'styleModulo', 'ADM', '/modules/modulos/adminBusquedaModulos.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (11, 'M-11', 11, 'PERFILES', 'MODULO DE PERFILES', 'stylePerfil', 'ADM', '/modules/perfiles/adminBusquedaPerfil.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (12, 'M-12', 12, 'INVENTARIOS', 'MODULO DE INVENTARIO', 'styleInvetario', 'GES', '/modules/inventario/adminBusquedaInventario.xhtml?faces-redirect=true', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, VALORTIPO, URL, ESTADO) VALUES (13, 'M-13', 13, 'REPORTES', 'MODULO DE REPORTE', 'styleReporte', 'GES', '/modules/reportes/adminBusquedaReporte.xhtml?faces-redirect=true', '1');

ALTER TABLE SCVNTMODULOS ADD COLUMN VALORTIPO VARCHAR(3);

UPDATE SCVNTMODULOS SET URL = '/modules/modulos/adminBusquedaModulos.xhtml?faces-redirect=true' WHERE CODIGOMODULO = 10;
...
ALTER TABLE SCVNTFACTURADETALLE ADD COLUMN CODIGOARTICULO INTEGER; 
