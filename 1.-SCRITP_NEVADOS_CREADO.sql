...
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (1, 'M-1', 1, 'ARTÍCULOS', 'MODULO DE ARTICULOS', 'styleArticle', '/modules/articulos/adminBusquedaArticulos.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (2, 'M-2', 2, 'CLIENTES', 'MODULO DE CLIENTES', 'styleClient', '/modules/clientes/adminBusquedaClientes.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (3, 'M-3', 3, 'PEDIDOS', 'MODULO DE PEDIDOS', 'stylePedidos', '/modules/pedidos/adminBusquedaPedidos.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (4, 'M-4', 4, 'TRANSPORTISTAS', 'MODULO DE TRANSPORTISTAS', 'styleTransportista', '/modules/transportistas/adminBusquedaTransportista.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (5, 'M-5', 5, 'CHOFER', 'MODULO DE CHOFER', 'styleChofer', '/modules/chofer/adminBusquedaChofer.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (6, 'M-6', 6, 'VEHÍCULOS', 'MODULO DE VEHÍCULOS', 'styleVehiculo', '/modules/vehiculo/adminBusquedaVehiculo.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (7, 'M-7', 7, 'DESPACHOS', 'MODULO DE DESPACHOS', 'styleDespacho', '/modules/despachos/adminBusquedaDespacho.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (8, 'M-8', 8, 'FACTURAS', 'MODULO DE FACTURAS', 'styleFactura', '/modules/facturas/adminBusquedaCuentas.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (9, 'M-9', 9, 'USUARIOS', 'MODULO DE USUARIOS', 'styleUsuario', '/modules/usuarios/adminBusquedaUsuarios.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (10, 'M-10', 10, 'MODULOS', 'MODULO DE MODULOS', 'styleModulo', '/modules/modulos/adminBusquedaModulos.jsf', '1');
INSERT INTO SCVNTMODULOS(CODIGOMODULO, CODIGOREFERENCIA, ORDEN, NOMBREMODULO, DESCRIPCION, ESTILO, URL, ESTADO) VALUES (11, 'M-11', 11, 'PERFILES', 'MODULO DE PERFILES', 'stylePerfil', '/modules/perfiles/adminBusquedaPerfil.jsf', '1');
